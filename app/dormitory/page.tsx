  ...
  const DormitoryCard = ({ dormitory }: { dormitory: IdormitoryDisplay }) => (
    ...
    >
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1 flex items-center gap-2">
        <FaMapMarkerAlt className="text-cyan-600" /> Address:{" "}
        {dormitory.address}
      </p>
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1 flex items-center gap-2">
        <FaCalendarAlt className="text-green-600" /> Billing Date:{" "}
        {dormitory.billingDate} of each month
      </p>
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1 flex items-center gap-2">
        <FaCalendarAlt className="text-blue-600" /> Check Date:{" "}
        {dormitory.checkDate} of each month
      </p>
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1 flex items-center gap-2">
        <FaDoorOpen className="text-yellow-600" /> Room Count:{" "}
        {dormitory.roomCount}
      </p>
