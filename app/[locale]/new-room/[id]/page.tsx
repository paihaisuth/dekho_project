        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="mb-2">
            <Toggle
              ...
              ariaLabel={t(locale, "roomCreationMode")}
              size="md"
              locale={locale}
            />
          </div>
          ...
          {mode === "single" ? (
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Input
                  label={t(locale, "prefix") + t(locale, "optional")}
                  value={form.prefix}
                  placeholder={t(locale, "enterPrefix")}
                  onChange={(e) => handleChange("prefix", e.target.value)}
                />
                <Input
                  label={t(locale, "charLength")}
                  type="number"
                  min={1}
                  placeholder={t(locale, "enterCharLength")}
